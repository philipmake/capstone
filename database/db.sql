...
-- Ward table (store information about a student, created by parent)
CREATE TABLE ward (
    id INT AUTO_INCREMENT PRIMARY KEY,
    parent_id INT NOT NULL,
    name VARCHAR(100) NOT NULL,          -- Ward’s name
...
CREATE TABLE availability (
    id INT AUTO_INCREMENT PRIMARY KEY,
    tutor_id INT,
    day ENUM('Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday', 'open to negotiation') NOT NULL,
